...
if __name__ == '__main__':
    ...
    # RNAp
    Best_param_p_xgb = get_best_params_set_xgb(RNAp_X_train_val, RNAp_y_train_val, 'xgb_RNAp')
    model(RNAp_X_train_val, RNAp_y_train_val, 'xgboost', 'pRNA', Best_param_p_xgb, save_plots=True)

    Best_alpha_p = find_optimal_alpha_Lasso(RNAp_X_train_val, RNAp_y_train_val, 'lasso_RNAp')
    model(RNAp_X_train_val, RNAp_y_train_val, model_name='lasso', data_name='pRNA', Best_param=Best_alpha_p, save_plots=True)

    # RNAi
    Best_param_i_xgb = get_best_params_set_xgb(RNAi_X_train_val, RNAi_y_train_val, 'xgb_RNAi')
    model(RNAi_X_train_val, RNAi_y_train_val, 'xgboost', 'iRNA', Best_param_i_xgb, save_plots=True)

    Best_alpha_i = find_optimal_alpha_Lasso(RNAi_X_train_val, RNAi_y_train_val, 'lasso_RNAi')
    model(RNAi_X_train_val, RNAi_y_train_val, model_name='lasso', data_name='iRNA', Best_param=Best_alpha_i, save_plots=True)
